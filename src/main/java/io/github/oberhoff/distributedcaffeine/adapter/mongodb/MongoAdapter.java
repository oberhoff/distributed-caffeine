...
public final class MongoAdapter<K, V> extends AbstractAdapter<K, V> {
    ...
    /**
     * Constructs an adapter based on MongoDB as the underlying store, using {@link Repository#DEFAULT_DISCRIMINATOR}.
     * <p>
    ...
    /**
     * Constructs an adapter based on MongoDB as the underlying store, using a custom discriminator.
     * <p>
     * <b>Note:</b> A discriminator must be used if different caches should share a relation in the underlying store.
     *
     * @param mongoClient    the mongo client used by the adapter
